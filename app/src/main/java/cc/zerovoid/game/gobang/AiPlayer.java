...
public class AiPlayer {
    ...
    private int[][] computerMap = new int[GameView.ROWS_NUM][GameView.COLS_NUM];
    private int[][] playerMap = new int[GameView.ROWS_NUM][GameView.COLS_NUM];
    // 电脑的棋子颜色
    ...
    public AiPlayer(ChessType[][] chessMap, ChessType computerType,
    ...
    private void initValue() {
        for (int r = 0; r < GameView.ROWS_NUM; r++) {
            for (int c = 0; c < GameView.COLS_NUM; c++) {
                computerMap[r][c] = 0;
                playerMap[r][c] = 0;
            }
        }
     ...
     * 电脑开始下子
     */
    public Point startLayDownChessPieces() {
                ...
                if (chessStatus[2] == ChessStatus.DIED) {
                    ...
                    if (chessStatus[2] == ChessStatus.ALIVE) {
                        ...
                        for (int p = tr1 + 1, q = tc1 + 1; p < tr1 + 5; p++, q++) {
                            if (p >= GameView.ROWS_NUM || q >= GameView.COLS_NUM) {
                                break;
                            }
