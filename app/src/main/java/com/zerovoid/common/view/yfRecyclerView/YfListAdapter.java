...
public abstract class YfListAdapter<T> extends RecyclerView.Adapter {
    ...
    public YfListAdapter(List<T> data) {
        this(data, YfListMode.MODE_DATA, 0);
    }

    public YfListAdapter(List<T> data, int mode) {
        this(data, mode, 0);
    }

    public YfListAdapter(List<T> data, int mode, int toolBarHeight) {
        this(data, null, null, mode, toolBarHeight);
    }

    public YfListAdapter(List<T> data, List<Object> headers, List<Object> footers, int mode, int toolBarHeight) {
