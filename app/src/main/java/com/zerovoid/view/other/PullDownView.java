package com.zerovoid.view.other;
 ...
 */
public class PullDownView extends LinearLayout implements ScrollOverListView.OnScrollOverListener, OnScrollListener {
    ...
    private void initHeaderViewAndFooterViewAndListView(Context context) {
        ...
        mFooterView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mIsNoMoreData || !mIsDidLoad || (state & STATE_LOADING_MORE) == STATE_LOADING_MORE)
                    return;
