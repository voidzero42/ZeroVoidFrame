 ...
 */
public class ZvCircleImageView extends ImageView {
    ...
    public ZvCircleImageView(Context context, int color, final float radius) {
        super(context);
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = ZvCircleImageView.this.getWidth();
            final int viewHeight = ZvCircleImageView.this.getHeight();
